...
class Layout
{
    ...
    public function __construct(string $view, mixed $data = null)
    {
        ...
        if(file_exists("app/View/View".$view.".inc.php")){
            if(file_exists("app/View/Layout/header.inc.php")) require_once "app/View/Layout/header.inc.php";
            else {
                $viewError = new View('Error');
                die();
            }
            $viewListarUsuarios = new View($view,$data);
            if(file_exists("app/View/Layout/footer.inc.php")) require_once "app/View/Layout/footer.inc.php";
            else {
                $viewError = new View('Error');
                die();
            }
