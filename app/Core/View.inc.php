<?php
require_once 'app/Core/Layout.inc.php';
/**
...
class View
{
     ...
     */
    public function __construct(string $template, mixed $data = null, bool $html = false)
    {
        ...
        if(file_exists('app/View/View' . $template . '.inc.php') || file_exists("app/View/View" . $template . ".html")) {
            ...
            if($html){
                require_once "app/View/View" . $this->template . ".html";
            }else{
                require_once 'app/View/View' . $this->template . '.inc.php';
